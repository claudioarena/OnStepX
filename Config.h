...
#define PINMAP                 RCX400_ESP //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB4, MaxESP4, MaxSTM3, FYSETC_E4,   <-Req'd
...
#define AXIS2_HOME_DEFAULT             -53 // Home when pointing horizontal south. So: 90 - latitute
...
#define TRACK_BACKLASH_RATE            12 //     20, n. Where n=2..50 (x sidereal rate) during backlash takeup.               Option
...
#define GOTO_OFFSET                  0.12 //   0.25, Offset in deg's for goto target unidirectional approach, 0.0 disables    Adjust
...
#define AXIS4_SLEW_RATE_BASE_DESIRED  500 //    500, n, Where n=200..5000 (um/s.) Adjustable at run-time from                <-Req'd
                                          //         1/2 to 2x this rate, and as performance considerations require.
#define AXIS4_SLEW_RATE_MINIMUM       500 //     20, n. Where n=5..600 (um/s.) Minimum microns/second.                        Adjust
